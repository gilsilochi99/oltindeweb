                                        ...
                                        {favoriteJobs.map(job => (
                                            <Card key={job.id}>
                                                ...
                                                <CardContent>
                                                    ...
                                                    <Button asChild variant="secondary" className="mt-4">
                                                        <Link href={`/jobs/${job.id}`}>Ver Empleo</Link>
                                                    </Button>
                                                </CardContent>
                                            </Card>
                                        ))}
                                    </div>
                                ) : <p className="text-center text-muted-foreground pt-6 border-t">No hay empleos en favoritos.</p>}
                            </AccordionContent>
                        </AccordionItem>
                    </Card>
                    <Card>
                                        ...
                                        {favoriteEvents.map(event => (
                                            <Card key={event.id}>
                                                <CardHeader>
                                                    ...
                                                    <CardDescription>{event.organizerName}</CardDescription>
                                                </CardHeader>
                                                <CardContent>
        ...
        <TabsContent value="subscriptions" className="mt-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Siga categorías y empresas para recibir notificaciones sobre nuevas ofertas, anuncios, empleos y eventos.</CardDescription>
                </CardHeader>
                 <CardContent>
                    <div className="text-center text-muted-foreground py-16 border-2 border-dashed">
                        <Bell className="w-12 h-12 mx-auto mb-4" />
                        <p>Gestione sus suscripciones a categorías y empresas, y elija qué notificaciones recibir por correo, desde su perfil.</p>
                        <Button asChild className="mt-6">
