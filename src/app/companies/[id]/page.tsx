...
import { Phone, Mail, Globe, Clock, MapPin, Tag, Linkedin, Facebook, Twitter, Building, CheckCircle, Info, Megaphone, Calendar, CalendarDays, TicketPercent, Briefcase, Users, Instagram, Smartphone, ShieldQuestion, Star, FileText, Download, Package, Camera } from "lucide-react";
...
export default async function CompanyDetailPage({ params }: { params: { id: string } }) {
    ...
    if (companyJobs.length > 0) defaultOpenAccordions.push('jobs');
    if (companyEvents.length > 0) defaultOpenAccordions.push('events');
