...
export default function AdminSettingsPage() {
    ...
    const handleSocialChange = (platform: keyof NonNullable<SiteSettings['socialMedia']>, value: string) => {
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Enlaces a los perfiles oficiales de Oltinde. Se muestran como iconos en el pie de página; deje en blanco los que no use.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                id="social-facebook"
                                placeholder="https://facebook.com/oltinde"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="social-twitter"
                                placeholder="https://x.com/oltinde"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="social-instagram"
                                placeholder="https://instagram.com/oltinde"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="social-linkedin"
                                placeholder="https://linkedin.com/company/oltinde"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="social-tiktok"
                                placeholder="https://tiktok.com/@oltinde"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="social-whatsapp"
                                placeholder="https://wa.me/240XXXXXXXXX"
