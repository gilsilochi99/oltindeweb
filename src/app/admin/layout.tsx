...
import { Home, Settings, Building, Briefcase, BriefcaseBusiness, Landmark, FileText, List, Users, Shield, Book, ShieldCheck, Newspaper, MapPin, Database, CalendarDays, Compass, Route, HeartPulse, UtensilsCrossed, HardHat } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const allNavLinks = [
    ...
    { href: '/admin/professionals', label: 'Profesionales', icon: HardHat, roles: ['admin', 'manager'] },
