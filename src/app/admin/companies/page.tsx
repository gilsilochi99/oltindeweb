                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <ul className="text-xs space-y-1">
                                <li>{company.cif && company.cif !== 'N/A' ? '✓' : '✗'} CIF proporcionado</li>
                                <li>{company.documents?.length ? '✓' : '✗'} Documento oficial adjunto</li>
                                <li>{company.ownerId ? '✓' : '✗'} Reclamada por un propietario</li>
                                <li>{company.logo && !company.logo.includes('placehold.co') ? '✓' : '✗'} Logo propio</li>
                              </ul>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
