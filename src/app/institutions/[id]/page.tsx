                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {branches.map(branch => (
                                            <div key={branch.id} className="p-3 border rounded-lg bg-muted/50 space-y-1">
                                                ...
                                                {branch.contact.phone && <a href={`tel:${branch.contact.phone}`} className="text-sm text-muted-foreground flex items-center gap-2 hover:text-primary hover:underline"><Phone className="w-4 h-4"/>{branch.contact.phone}</a>}
