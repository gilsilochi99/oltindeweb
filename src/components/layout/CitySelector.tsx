...
export function CitySelector() {
    ...
    const { city: preferredCity, setCity: setPreferredCity } = useCityPreference();

    // An explicit ?city= in the current URL always wins (keeps shared/bookmarked
    // links accurate); otherwise fall back to the sitewide persisted preference
    // instead of always defaulting to "all", so the choice survives navigation.
